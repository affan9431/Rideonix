    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4 py-8">
      <form onSubmit={handleSubmit} className="w-full max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          ...
          {/* City */}
          <div>
            <label className="block text-lg font-semibold">City Name</label>
            <input
              type="text"
              name="cityName"
              value={formData.cityName}
              className="w-full bg-gray-400 text-gray-200 border-b border-black focus:outline-none mt-1"
              readOnly
            />
          </div>
          ...
          {/* Vehicle */}
          <div>
            <label className="block text-lg font-semibold">Vehicle type</label>
            <input
              type="text"
